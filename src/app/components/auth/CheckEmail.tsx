      ...
      <div className="flex flex-col items-center">
        ...
        <div className="mb-8 flex flex-col items-center gap-4">
          ...
          <div className="text-center">
            <h1 className="text-[24px] font-medium text-white mb-2 font-['Inter_Tight']">Hello, user!</h1>
            <p className="text-[16px] text-[#717784] max-w-[400px] font-['Inter_Tight'] leading-[24px]">
              A request has been made to reset your password for <span className="text-white font-medium">{email}</span>. If you made this request, please click on the button below.
            </p>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col gap-4">
          ...
          <button 
            ...
            className="text-[14px] font-medium text-[#717784] hover:text-white transition-colors"
          >
            Back to reset
          </button>
        </div>
