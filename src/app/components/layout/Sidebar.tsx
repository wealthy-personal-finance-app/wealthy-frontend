          ...
          <div className="absolute inset-[58.33%_83.33%_41.67%_8.33%]">
            <div className="absolute inset-[-0.75px_-45%]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 3.16667 1.5"
              >
                <path
                  d="M0.75 0.75H2.41667"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.5"
          ...
          <div className="absolute inset-[54.17%_37.5%_37.5%_62.5%]">
            <div className="absolute inset-[-45%_-0.75px]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 1.5 3.16667"
              >
                <path
                  d="M0.75 0.75V2.41667"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.5"
          ...
          <div className="absolute inset-[72.5%_16.25%_27.5%_35%]">
            <div className="absolute inset-[-0.94px_-9.62%]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 11.625 1.875"
              >
                <path
                  d="M0.9375 0.9375H10.6875"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.875"
          ...
          <div className="absolute inset-[72.5%_83.72%_27.5%_16.25%]">
            <div className="absolute inset-[-0.94px]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 1.88167 1.875"
              >
                <path
                  d="M0.9375 0.9375H0.944167"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.875"
          ...
          <div className="absolute bottom-1/2 left-[16.25%] right-[83.72%] top-1/2">
            <div className="absolute inset-[-0.75px]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 1.50667 1.5"
              >
                <path
                  d="M0.75 0.75H0.756667"
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.5"
          ...
          <div className="absolute inset-[31.23%_39.05%_46.25%_39.09%]">
            <div className="absolute inset-[-16.65%_-17.15%_-16.66%_-17.16%]">
              <svg
                ...
                fill="none"
                preserveAspectRatio="none"
                viewBox="0 0 5.87271 6.00356"
              >
                <path
                  d={svgPaths.p2fab6600}
                  stroke="currentColor"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  strokeWidth="1.5"
              ...
              <defs>
                ...
                >
                  ...
                  <feBlend
                    in2="shape"
                    mode="normal"
                    result="effect1_innerShadow_3_3011"
                  />
                </filter>
                <filter
                  colorInterpolationFilters="sRGB"
...
export function Sidebar({
  ...
  return (
    <div className="bg-[#191b1f] flex flex-col h-full w-[280px]">
      ...
      {/* Main Content */}
      <div className="flex-1 min-h-0 flex flex-col px-[16px] pb-[16px]">
        {/* Main Navigation */}
            ...
            <div className="flex flex-col gap-[4px]">
              {mainLinks.map((link) => (
                ...
                >
                  ...
                  <span className="flex-1 text-system-label">{link.label}</span>
                </button>
              ))}
            </div>
          </div>
          ...
          {activeLink === "ai-assistant" && (
            <>
              ...
              <div className="flex-1 min-h-0 flex flex-col gap-[12px]">
                ...
                <div className="flex-1 min-h-0 flex flex-col gap-[4px]">
                  <div className="pl-[12px]">
                    <p className="caption text-[#99a0ae] mb-[4px] text-[15px]">
                      Recent Chats
                    </p>
                  </div>
                  <div className="flex-1 min-h-0 overflow-y-auto mr-[-16px] pr-[16px] flex flex-col gap-[0px]">
                    {chatLinks?.map((chat) => (
                      <button
                        key={chat.id}
                        onClick={() => onChatClick?.(chat.id)}
                        className={`w-full text-left py-[8px] px-[12px] rounded-[8px] transition-colors cursor-pointer ${
                          activeChatId === chat.id
                            ? "bg-[rgba(65,63,63,0.5)] border border-[#2e2f33] text-white"
                            : "text-[#717784] hover:bg-[rgba(65,63,63,0.3)]"
                        }`}
                      >
                        <p className="font-['Inter_Tight',sans-serif] text-[14px] leading-[18px] w-[224px] overflow-hidden text-ellipsis whitespace-nowrap">
                          {chat.label} ...
                        </p>
                      </button>
                    ))}
        ...
        {bottomLinks && bottomLinks.length > 0 && (
          <div className="flex flex-col gap-[4px] mt-4 shrink-0">
                    ...
                    <div className="absolute inset-[32%_41%]">
                      <div className="absolute inset-[-13.02%_-26.04%]">
                        <svg
                          ...
                          fill="none"
                          preserveAspectRatio="none"
                          viewBox="0 0 5.475 9.075"
                        >
                          <path
                            d={svgPaths.p2eec8980}
                            stroke="currentColor"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            strokeWidth="1.875"
