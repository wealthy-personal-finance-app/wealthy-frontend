  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <path d={svgPaths.p2e356bf0} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
        <path d="M7.70833 8.33333H12.2917" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
      </svg>
    </div>
  );
}
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="relative shrink-0 w-full">
        <div className="flex flex-col gap-[16px] items-start px-[32px] pt-[16px] pb-[16px] relative w-full">
          <p style={{ fontFamily: 'var(--font-family)', fontSize: '20px', lineHeight: '26px', fontWeight: 500, color: 'white', whiteSpace: 'nowrap' }}>
            Transactions
          </p>
              ...
              {tabs.map(({ id, label, Icon }) => {
                ...
                return (
                  <button
                    ...
                    style={{ backgroundColor: isActive ? 'rgba(65,63,63,0.5)' : 'transparent' }}
                  >
                    {isActive && (
                      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[8px]" style={{ boxShadow: '0px 1px 6px 0px rgba(14,18,27,0.08)' }} />
                    )}
                    <div className="flex gap-[8px] items-center justify-center px-[24px] py-[4px] relative">
                      <div style={{ color: isActive ? 'white' : '#99A0AE' }}><Icon /></div>
                      <span style={{ fontFamily: 'var(--font-family)', fontSize: '16px', lineHeight: '24px', fontWeight: isActive ? 500 : 400, color: isActive ? 'white' : '#717784', whiteSpace: 'nowrap' }}>
                        {label}
                      </span>
                    </div>
                  </button>
