...
export function AddTransactionModal({
  ...
  const handleFinalSave = () => {
    const selectedCat = currentCategories.find(
      (c) => c.label === category || c.id === category || c._id === category
    )
    ...
    >
      <div className="bg-[#191b1f] border border-[#2e2f33] rounded-[16px] w-full max-w-[540px] max-h-full p-[24px] flex flex-col gap-[20px] shadow-[0px_10px_100px_0px_rgba(10,10,57,0.15)] animate-in fade-in zoom-in-95 duration-200 overflow-hidden">
        <div className="flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-[4px] hover:bg-[#2e2f33] rounded-full transition-colors"
          >
        ...
        <div className="bg-[#131417] border border-[#2e2f33] rounded-[12px] p-[4px] flex gap-[4px] shrink-0">
          {(["Expense", "Income", "Asset", "Liability"] as AllowedTypes[]).map(
            (type) => (
              <button
                key={type}
                onClick={() => {
                ...
                className={`flex-1 flex items-center justify-center py-[6px] px-[8px] rounded-[8px] transition-all duration-200 ${
        ...
        <div
          className={`flex-1 min-h-0 flex flex-col gap-[16px] overflow-y-auto pr-[4px] scrollbar-hide transition-all duration-300 ${
            isCategoryOpen || isCalendarOpen ? "pb-[240px]" : "pb-[8px]"
          }`}
        >
          {/* Transaction Amount */}
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="relative w-full" ref={categoryRef}>
              <div
                ...
                className={`bg-[#131417] border border-[#2e2f33] h-[40px] px-[12px] flex items-center justify-between relative ${
                  isCategoryOpen
                    ? "rounded-t-[8px] rounded-b-none"
                    : "rounded-[8px]"
                } w-full focus-within:border-[#99a0ae] transition-colors cursor-pointer shadow-inner`}
              >
                <div className="flex items-center gap-[12px]">
                  {category ? (
                    <div className="w-[24px] h-[24px] flex items-center justify-center shrink-0">
                      <CategoryIcon
                        icon={
                          currentCategories.find((c) => c.label === category)
                            ?.icon || "star"
                        }
                        size={18}
                        color="#99a0ae"
                  ...
                  <span
                    className={`font-['Inter_Tight',sans-serif] font-medium text-[16px] ${
                      category ? "text-white" : "text-[#717784]"
                    }`}
                  >
                  ...
                  {categoryViewState === "list" ? (
                          ...
                          <>
                            {Object.entries(
                              filteredCategories.reduce((acc, cat) => {
                                if (!acc[cat.masterCategory])
                                  acc[cat.masterCategory] = []
                    ...
                    <div className="w-full flex flex-col gap-[16px]">
                      ...
                      <div className="flex gap-[8px] pt-[8px]">
                        ...
                        <button
                          disabled={
                            !newCategoryLabel.trim() || !selectedMasterCategory
                          }
                          onClick={(e) => {
                            e.stopPropagation()
          ...
          <div className="flex flex-col gap-[8px]">
            ...
            <div className="relative" ref={calendarRef}>
              <div
                className={`bg-[#131417] border border-[#2e2f33] flex items-center justify-between px-[12px] h-[40px] relative ${
                  isCalendarOpen ? "rounded-t-[8px]" : "rounded-[8px]"
                } w-full focus-within:border-[#99a0ae] transition-all cursor-pointer shadow-inner`}
                ...
                <div className="absolute top-[100%] left-0 right-0 z-[60] bg-[#15161a] border border-[#2e2f33] border-t-0 rounded-b-[16px] p-[16px] shadow-2xl animate-in fade-in slide-in-from-top-2 duration-200">
                  ...
                  <div className="grid grid-cols-7 gap-[2px]">
                    ...
                    {days.map((d) => {
                      const isSelected =
                        date ===
                        new Date(year, viewDate.getMonth(), d)
                          .toISOString()
                          .split("T")[0]
                      return (
                        <button
        ...
        <div className="flex items-center gap-[12px] pt-[8px]">
          ...
          <button
            ...
            disabled={
              !category || !amount || amount === "0" || !transactionName
            }
